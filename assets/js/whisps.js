...
function init() {
    handleResize();
    window.requestAnimationFrame(draw);
    whispSurfaces[0].addEventListener( 'resize', handleResize, );
    // window.addEventListener( 'mousemove', handleMouseMove );
    // window.addEventListener( 'mouseup', handleMouseUp );
    // window.addEventListener( 'mousedown', handleMouseDown );
    whispSurfaces[0].onmousemove = handleMouseMove;
    whispSurfaces[0].onmouseup = handleMouseUp;
    whispSurfaces[0].onmousedown = handleMouseDown;
}
init();
